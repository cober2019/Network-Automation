...
def main():
    ...
    while True:
        ...
        print("8. Re-eneter API Key & Org ID ")
...
def get_meraki_networks():
  ...
  except (FileExistsError, FileNotFoundError, UnboundLocalError, json.JSONDecodeError):
      print("\n")
      print("JSON Date didnt convert, please  check if the content was fetched correctly. If not, \n"
            "please check API Key and Org ID | GET Response: %s" % response)
      main()
